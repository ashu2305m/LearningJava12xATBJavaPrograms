...
public class Lab176 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(vwoLogin1.getUsername());  // admin
        System.out.println(vwoLogin1.getPassword());  // pwd123

        vwoLogin1.setUsername("pramod");
        System.out.println(vwoLogin1.getUsername());  // pramod
        vwoLogin1.setPassword("raodask@!@3",true);
        System.out.println(vwoLogin1.getPassword());  // raodask@!@3
